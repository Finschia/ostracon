...
func (_m *AppConnConsensus) BeginBlockSync(_a0 types.RequestBeginBlock) (*abcitypes.ResponseBeginBlock, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(types.RequestBeginBlock) (*abcitypes.ResponseBeginBlock, error)); ok {
		return rf(_a0)
	}
...
func (_m *AppConnConsensus) CommitSync() (*abcitypes.ResponseCommit, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func() (*abcitypes.ResponseCommit, error)); ok {
		return rf()
	}
...
func (_m *AppConnConsensus) EndBlockSync(_a0 abcitypes.RequestEndBlock) (*abcitypes.ResponseEndBlock, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(abcitypes.RequestEndBlock) (*abcitypes.ResponseEndBlock, error)); ok {
		return rf(_a0)
	}
...
func (_m *AppConnConsensus) InitChainSync(_a0 abcitypes.RequestInitChain) (*abcitypes.ResponseInitChain, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(abcitypes.RequestInitChain) (*abcitypes.ResponseInitChain, error)); ok {
		return rf(_a0)
	}
