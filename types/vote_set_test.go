...
func TestAddVote(t *testing.T) {
	...
	voteSet, _, _, privValidators := randVoteSet(height, round, PrevoteType, 10, 1)
...
func Test2_3MajorityRedux(t *testing.T) {
	height, round := int64(1), 0
	voteSet, _, _, privValidators := randVoteSet(height, round, PrevoteType, 100, 1)
...
func TestConflicts(t *testing.T) {
	height, round := int64(1), 0
	voteSet, _, _, privValidators := randVoteSet(height, round, PrevoteType, 4, 1)
...
func TestMakeCommit(t *testing.T) {
	height, round := int64(1), 0
	voteSet, _, _, privValidators := randVoteSet(height, round, PrecommitType, 10, 1)
