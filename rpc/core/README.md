...
The user can subscribe to events emitted by Ostracon, using `/subscribe`. If
...
("client is not pulling messages fast enough"). If Ostracon exits, all
subscriptions are canceled ("Ostracon exited"). The user can unsubscribe
