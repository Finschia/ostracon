...
import (
	bytes "github.com/line/ostracon/libs/bytes"
	client "github.com/line/ostracon/rpc/client"
...
// ValidatorsWithVoters provides a mock function with given fields: ctx, height, page, perPage
func (_m *RemoteClient) ValidatorsWithVoters(ctx context.Context, height *int64, page *int, perPage *int) (*coretypes.ResultValidatorsWithVoters, error) {
	ret := _m.Called(ctx, height, page, perPage)

	var r0 *coretypes.ResultValidatorsWithVoters
	if rf, ok := ret.Get(0).(func(context.Context, *int64, *int, *int) *coretypes.ResultValidatorsWithVoters); ok {
		r0 = rf(ctx, height, page, perPage)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*coretypes.ResultValidatorsWithVoters)
		}
	}
...
func (_m *RemoteClient) Voters(ctx context.Context, height *int64, page *int, perPage *int) (*coretypes.ResultVoters, error) {
	ret := _m.Called(ctx, height, page, perPage)
