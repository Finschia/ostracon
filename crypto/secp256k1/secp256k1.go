...
func (privKey PrivKeySecp256k1) VRFProve(seed []byte) (crypto.Proof, error) {
...
func (pubKey PubKeySecp256k1) VRFVerify(proof crypto.Proof, seed []byte) (crypto.Output, error) {
