...
var RootCmd = &cobra.Command{
	Use:   "maverick",
	Short: "Ostracon Maverick Node",
	Long: "Ostracon Maverick Node for testing with faulty consensus misbehaviors in a testnet. Contains " +
	...
	PersistentPreRunE: func(cmd *cobra.Command, args []string) (err error) {
		...
		logger, err = log.ParseLogLevel(config.LogLevel, logger, cfg.DefaultPackageLogLevels())
		if err != nil {
			return err
		}
