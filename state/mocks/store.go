...
func (_m *Store) LoadVoters(_a0 int64, _a1 *ostracontypes.VoterParams) (*ostracontypes.ValidatorSet, *ostracontypes.VoterSet, *ostracontypes.VoterParams, []byte, error) {
	ret := _m.Called(_a0, _a1)

	var r0 *ostracontypes.ValidatorSet
	if rf, ok := ret.Get(0).(func(int64, *ostracontypes.VoterParams) *ostracontypes.ValidatorSet); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*ostracontypes.ValidatorSet)
	...
	var r1 *ostracontypes.VoterSet
	if rf, ok := ret.Get(1).(func(int64, *ostracontypes.VoterParams) *ostracontypes.VoterSet); ok {
		r1 = rf(_a0, _a1)
	} else {
		if ret.Get(1) != nil {
			r1 = ret.Get(1).(*ostracontypes.VoterSet)
		}
	}

	var r2 *ostracontypes.VoterParams
	if rf, ok := ret.Get(2).(func(int64, *ostracontypes.VoterParams) *ostracontypes.VoterParams); ok {
		r2 = rf(_a0, _a1)
	} else {
		if ret.Get(2) != nil {
			r2 = ret.Get(2).(*ostracontypes.VoterParams)
		}
	}

	var r3 []byte
	if rf, ok := ret.Get(3).(func(int64, *ostracontypes.VoterParams) []byte); ok {
		r3 = rf(_a0, _a1)
	} else {
		if ret.Get(3) != nil {
			r3 = ret.Get(3).([]byte)
	...
	var r4 error
	if rf, ok := ret.Get(4).(func(int64, *ostracontypes.VoterParams) error); ok {
		r4 = rf(_a0, _a1)
	} else {
		r4 = ret.Error(4)
	}
