...
func (_m *BlockStore) LoadBaseMeta() (*types.BlockMeta, error) {
	ret := _m.Called()
...
func (_m *BlockStore) LoadBlock(height int64) (*types.Block, error) {
...
func (_m *BlockStore) LoadBlockByHash(hash []byte) (*types.Block, error) {
	ret := _m.Called(hash)
...
func (_m *BlockStore) LoadBlockMeta(height int64) (*types.BlockMeta, error) {
	ret := _m.Called(height)
...
func (_m *BlockStore) LoadBlockPart(height int64, index int) (*types.Part, error) {
...
func (_m *BlockStore) LoadSeenCommit(height int64) (*types.Commit, error) {
	ret := _m.Called(height)
