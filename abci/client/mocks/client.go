...
func (_m *Client) BeginRecheckTxAsync(_a0 types.RequestBeginRecheckTx) *abcicli.ReqRes {
	ret := _m.Called(_a0)
...
func (_m *Client) EndRecheckTxAsync(_a0 types.RequestEndRecheckTx) *abcicli.ReqRes {
	ret := _m.Called(_a0)
