...
func (_m *Client) BeginBlockSync(_a0 ocabci.RequestBeginBlock) (*types.ResponseBeginBlock, error) {
	ret := _m.Called(_a0)
...
func (_m *Client) CheckTxSync(_a0 types.RequestCheckTx) (*ocabci.ResponseCheckTx, error) {
	ret := _m.Called(_a0)
