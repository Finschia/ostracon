...
type Commit struct {
	...
	// Additional field that LINE Blockchain uses for aggregated signature. For protobuf, the tags in the 1 to 15 is
	// packed into a single byte, so we use 15 to account for differential expansions imported from Tendermint.
	AggregatedSignature  []byte   `protobuf:"bytes,15,opt,name=aggregated_signature,json=aggregatedSignature,proto3" json:"aggregated_signature,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
var fileDescriptor_ff06f8095857fb18 = []byte{
	...
	,
}
