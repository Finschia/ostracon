		...
		},
		{
			...
			map[int64]*types.SignedHeader{
				...
				3: transitKeys.GenSignedHeader(chainID, 3, bTime.Add(2*time.Hour), nil,
					types.ToVoterAll(transitVals.Validators), transitVals, transitVals,
